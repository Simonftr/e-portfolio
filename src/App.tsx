...
export type SkillType = 'realiser' | 'optimiser' | 'administrer' | 'gerer' | 'conduire' | 'collaborer' | null;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-16">
        {currentSection === 'home' && <Hero onNavigate={handleNavigate} language={language} />}
        ...
        {currentSection === 'skills' && (
          selectedSkill ? (
            ...
            <BachelorSkills onSkillSelect={handleSkillSelect} language={language} />
          )
        )}
