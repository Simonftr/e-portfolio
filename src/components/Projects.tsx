  ...
  fr: [
    {
      ...
      title: "Botanic",
      description:
        "Application métier en C# développée en première année. Implémentation d'interfaces utilisateur, gestion de la logique métier et validation des formulaires.",
      image:
        "https://images.unsplash.com/photo-1652600737672-12942122d1c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
    ...
    },
    {
      ...
      title: "Scodoc",
      description:
        "Système de gestion d'étudiants et de notes en PostgreSQL. Conception d'un schéma relationnel complet, scripts SQL, gestion de l'intégrité des données.",
      image:
        "https://images.unsplash.com/photo-1643982102543-bc057db646cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
    ...
    },
    {
      ...
      title: "Vinted_API",
      description:
        "API REST en C# permettant de manipuler des données PostgreSQL pour une version simplifiée de Vinted. Conception d'endpoints, validation des données et documentation complète.",
      image:
        "https://images.unsplash.com/photo-1666358052008-a9a1ecda7885?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
    ...
    },
    {
      ...
      title: "VintedClient",
      description:
        "Interface web en Vue pour la consultation d'annonces. Affichage de produits, filtres de recherche et consultation détaillée avec cohérence graphique.",
      image:
        "https://images.unsplash.com/photo-1649451844931-57e22fc82de3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
    ...
    },
    {
      ...
      title: "movie_app",
      description:
        "Application mobile Flutter affichant une liste de films depuis une API. Architecture modulaire, navigation entre écrans et gestion de l'état.",
      image:
        "https://images.unsplash.com/photo-1760404699908-6b9b8f11f424?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
    ...
    },
    {
      ...
      description:
        "Application iOS en Swift pour gérer une liste d'entraîneurs Pokémon. Conception de vues, modèles de données et navigation.",
      image:
        "https://images.unsplash.com/photo-1650573547848-d7b93ed79782?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
  ...
  en: [
    {
      ...
      title: "Botanic",
      description:
        "Business application in C# developed in first year. User interface implementation, business logic management and form validation.",
      image:
        "https://images.unsplash.com/photo-1652600737672-12942122d1c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
      technologies: ["C#", ".NET", "WPF", "Git"],
      skills: ["realiser", "conduire", "collaborer"],
    ...
    },
    {
      ...
      title: "Scodoc",
      description:
        "Student and grade management system in PostgreSQL. Complete relational schema design, SQL scripts, data integrity management.",
      image:
        "https://images.unsplash.com/photo-1643982102543-bc057db646cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
      technologies: ["PostgreSQL", "SQL", "Git"],
      skills: ["realiser", "optimiser", "administrer", "gerer", "collaborer"],
    ...
    },
    {
      ...
      title: "Vinted_API",
      description:
        "REST API in C# to manipulate PostgreSQL data for a simplified Vinted version. Endpoint design, data validation and complete documentation.",
      image:
        "https://images.unsplash.com/photo-1666358052008-a9a1ecda7885?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
      technologies: ["C#", ".NET", "PostgreSQL", "REST API", "Swagger"],
      skills: [
    ...
    },
    {
      ...
      title: "VintedClient",
      description:
        "Web interface in Vue for browsing listings. Product display, search filters and detailed view with graphic consistency.",
      image:
        "https://images.unsplash.com/photo-1649451844931-57e22fc82de3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
      technologies: ["Vue.js", "JavaScript", "CSS", "Axios"],
      skills: ["realiser", "conduire", "collaborer"],
    ...
    },
    {
      ...
      title: "movie_app",
      description:
        "Flutter mobile app displaying a movie list from an API. Modular architecture, screen navigation and state management.",
      image:
        "https://images.unsplash.com/photo-1760404699908-6b9b8f11f424?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
      technologies: ["Flutter", "Dart", "REST API", "Git"],
      skills: ["realiser", "optimiser", "collaborer"],
    ...
    },
    {
      ...
      title: "Pokémon Trainer Manager",
      description:
        "iOS app in Swift to manage a list of Pokémon trainers. View design, data models and navigation.",
      image:
        "https://images.unsplash.com/photo-1650573547848-d7b93ed79782?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
      technologies: ["Swift", "SwiftUI", "Xcode", "Git"],
      skills: ["realiser", "conduire", "collaborer"],
