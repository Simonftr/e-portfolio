...
const content = {
  fr: {
    ...
    subtitle: 'En alternance, passionné par le développement d\'applications modernes et performantes',
    currentGoal: 'Actuellement en poste, concentré sur mon alternance et ma formation',
  ...
  en: {
    ...
    subtitle: 'Work-study student passionate about modern and efficient application development',
    currentGoal: 'Currently employed, focused on my work-study program and education',
