...
const projectsData = {
  botanic: {
    fr: {
      ...
      year: "BUT 1",
      context:
        "Projet de première année visant à développer une application de gestion pour une jardinerie. L'objectif était d'apprendre les bases du développement logiciel en créant une solution métier complète.",
      objectives: [
    ...
    en: {
      ...
      year: "BUT 1",
      context:
        "First-year project aimed at developing a management application for a garden center. The goal was to learn software development basics by creating a complete business solution.",
      objectives: [
  ...
  scodoc: {
    fr: {
      ...
      year: "BUT 1",
      context:
        "Projet de base de données pour gérer les étudiants, leurs notes et leurs relevés. Ce projet visait à apprendre la modélisation et l'implémentation de bases de données relationnelles.",
      objectives: [
    ...
    en: {
      ...
      year: "BUT 1",
      context:
        "Database project to manage students, their grades and reports. This project aimed to learn relational database modeling and implementation.",
      objectives: [
  ...
  vinted_api: {
    fr: {
      ...
      year: "BUT 2",
      context:
        "Développement d'une API REST en C# pour une plateforme de vente de vêtements inspirée de Vinted. L'objectif était de créer un backend robuste avec une base de données PostgreSQL.",
      objectives: [
    ...
    en: {
      ...
      year: "BUT 2",
      context:
        "Development of a REST API in C# for a clothing sales platform inspired by Vinted. The goal was to create a robust backend with a PostgreSQL database.",
      objectives: [
  ...
  vinted_client: {
    fr: {
      ...
      year: "BUT 2",
      context:
        "Développement de l'interface utilisateur web pour la plateforme Vinted, consommant l'API développée précédemment. Focus sur l'expérience utilisateur et le responsive design.",
      objectives: [
    ...
    en: {
      ...
      year: "BUT 2",
      context:
        "Development of the web user interface for the Vinted platform, consuming the previously developed API. Focus on user experience and responsive design.",
      objectives: [
  ...
  movie_app: {
    fr: {
      ...
      year: "BUT 2",
      context:
        "Développement d'une application mobile avec Flutter permettant de consulter des informations sur les films via une API publique (TMDB). Introduction au développement mobile cross-platform.",
      objectives: [
    ...
    en: {
      ...
      year: "BUT 2",
      context:
        "Development of a mobile application with Flutter to consult movie information via a public API (TMDB). Introduction to cross-platform mobile development.",
      objectives: [
  ...
  pokemon_trainer: {
    fr: {
      ...
      year: "BUT 3",
      context:
        "Développement d'une application iOS native en Swift pour gérer une collection d'entraîneurs Pokémon. Ce projet visait à apprendre le développement iOS natif avec UIKit.",
      objectives: [
    ...
    en: {
      ...
      year: "BUT 3",
      context:
        "Development of a native iOS application in Swift to manage a collection of Pokémon trainers. This project aimed to learn native iOS development with UIKit.",
      objectives: [
...
export function ProjectDetail({
  ...
  const project =
    projectsData[projectId as keyof typeof projectsData]?.[language];
